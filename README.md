...
```bash
PATHFINDER_MODEL=gemini/gemini-2.5-flash      # Google
...
| `PATHFINDER_MODEL` | `gemini/gemini-2.5-flash` | Model for graph navigation decisions |
| `SUMMARIZER_MODEL` | `gemini/gemini-2.5-flash` | Model for text summarization |
| `VERIFIER_MODEL` | `gemini/gemini-2.5-flash` | Model for anti-hallucination verification |
| `EMBEDDING_MODEL` | `gemini/gemini-embedding-001` | Embedding model (3072-dim vectors) |
